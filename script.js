function generateTable() {
    ...
    for (let i = 0; i < M.length; i++) 
    {
        ...
        if (A.charAt(0) == '0') 
        {
            // Shift AQ
            // A = A.substring(1) + Q.charAt(0);
            tableHTML += "<tr>  <td>" + n + "</td>   <td>" + M + "</td> <td><span style='color: red;'>" + A.charAt(0) +"</span><span >"+ A.substring(1) + "</span></td>  <td><span >" + Q.substring(1,len-i) +"</span><span style='color: black;' >"+ Q.substring(len-i)+"_" + "</span></td>   <td>" + "SHIFT LEFT AQ" + "</td         </tr>";

            // A = A-M
            A =  addBinaryStrings(A,complement);

            if( A.length != M.length +1)
            {
                A = A.substring(1);
            }
                

            tableHTML += "<tr>   <td>" + " " + "</td>  <td>" + M + "</td> <td><span style='color: red;'>" + A.charAt(0) +"</span><span >"+ A.substring(1) + "</span></td>  <td><span >" + Q.substring(1,len-i) +"</span><span style='color: black;' >"+ Q.substring(len-i)+"_" + "</span></td>    <td>" + "A = A-M" + "</td         </tr>";
        ...
        {
            Q = Q+ "1";
            tableHTML += "<tr>   <td>" + " " + "</td>  <td>" + M + "</td> <td><span style='color: red;'>" + A.charAt(0) +"</span><span >"+ A.substring(1) + "</span></td>  <td><span >" + Q.substring(0,len-i-1) +"</span><span style='color: black;' >"+ Q.substring(len-i-1) + "</span></td>    <td>" + "Q[0] = 1" + "</td         </tr>";

        }
        else
        {
            Q = Q + "0";
            tableHTML += "<tr>   <td>" + " " + "</td>  <td>" + M + "</td> <td><span style='color: red;'>" + A.charAt(0) +"</span><span >"+ A.substring(1) + "</span></td>  <td><span >" + Q.substring(0,len-i-1) +"</span><span style='color: black;' >"+ Q.substring(len-i-1) + "</span></td>    <td>" + "Q[0] = 0" + "</td         </tr>";
    ...
    datahtml += "<p>DIVISOR(M) = " + divisor + " (" + M+ ")"+"</p>"
    datahtml += "<p>COMPLEMENT(-M) = " + -divisor + " (" + complement+ ")"+"</p>"
